...
def render_views(mesh_path, output_dir="rendered_views", num_views=2, width=512, height=512):
    ...
    if has_vertex_colors:
        ...
        print("🖼️ Using texture map.")
        mat.shader = "defaultLit"
    else:
        print("⚠️ No vertex colors or texture. Using default grey.")
        mat.shader = "defaultLit"
    ...
    for i in range(num_views):
        ...
        y = cam_distance * np.cos(phi)               # vertical position
...
# render_views("outputs/hunyuan/camera.glb", output_dir="views_for_met3r/hunyuan", num_views=8)
# render_views("outputs/instantmesh/camera.obj", output_dir="views_for_met3r/instantmesh", num_views=8)
# render_views("outputs/lgm/camera.glb", output_dir="views_for_met3r/lgm", num_views=8)
# render_views("outputs/triposr/1/mesh.obj", output_dir="views_for_met3r/triposr", num_views=8)
# render_views("outputs/zeroshape/preds/camera_mesh.ply", output_dir="views_for_met3r/zeroshape", num_views=8)
